...
namespace _5_Stars_Reviews.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReviewId,ReviewName,Genre,FilmId")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ReviewId,ReviewName,Genre,FilmId")] Review review)
        {
            if (ModelState.IsValid)
            {
